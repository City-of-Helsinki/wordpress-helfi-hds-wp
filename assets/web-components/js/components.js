...
exports.y = exports.x = exports.s = exports.i = exports.e = exports.c = void 0;
  ...
  _createClass(o$3, [{
    ...
    get: function get() {
      ...
      if (e$3 && void 0 === t) {
        ...
        _e && (t = n$4.get(s)), void 0 === t && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), _e && n$4.set(s, t));
      }
      return t;
    }
  }, {
...
var r$2 = function r$2(t) {
  ...
  S$1 = function S$1(s, n) {
    e$3 ? s.adoptedStyleSheets = n.map(function (t) {
...
var d$1 = /*#__PURE__*/function (_HTMLElement) {
  _inherits(d$1, _HTMLElement);
  var _super = _createSuper(d$1);
  function d$1() {
    var _this;
    _classCallCheck(this, d$1);
  ...
  _createClass(d$1, [{
    ...
    value: function _$EO(t, i) {
      ...
      if (void 0 !== r && !0 === s.reflect) {
        var _h = (void 0 !== (null === (e = s.converter) || void 0 === e ? void 0 : e.toAttribute) ? s.converter : n$3).toAttribute(i, s.type);
    ...
    value: function _$AK(t, i) {
      ...
      if (void 0 !== r && this._$El !== r) {
        var _t = e.getPropertyOptions(r),
          ...
          } : void 0 !== (null === (s = _t.converter) || void 0 === s ? void 0 : s.fromAttribute) ? _t.converter : n$3;
    ...
    key: "_$Ej",
    value: function () {
      var _$Ej2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var t;
      ...
      if (t.finalize(), void 0 !== t.h && (this.h = _toConsumableArray(t.h)), this.elementProperties = new Map(t.elementProperties), this._$Ev = new Map(), this.hasOwnProperty("properties")) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            this.createProperty(_s3, _t2[_s3]);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
  ...
  function C(_ref, e) {
    ...
    if (this.el = C.createElement(v, e), A.currentNode = this.el.content, 2 === i) {
      var _t3 = this.el.content,
        _i4 = _t3.firstChild;
      _i4.remove(), _t3.append.apply(_t3, _toConsumableArray(_i4.childNodes));
    }
    for (; null !== (l = A.nextNode()) && c.length < u;) {
      if (1 === l.nodeType) {
        if (l.hasAttributes()) {
          var _t4 = [];
          var _iterator4 = _createForOfIteratorHelper(l.getAttributeNames()),
            _step4;
          try {
...
var V = /*#__PURE__*/function () {
  ...
  _createClass(V, [{
    ...
    value: function p(t) {
      var i = 0;
      var _iterator5 = _createForOfIteratorHelper(this.u),
        _step5;
      try {
...
var s = /*#__PURE__*/function (_d$) {
  ...
  _createClass(s, [{
    ...
    value: function update(t) {
      var i = this.render();
      this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), _get(_getPrototypeOf(s.prototype), "update", this).call(this, t), this._$Do = Z(i, this.renderRoot, this.renderOptions);
    }
  }, {
    key: "connectedCallback",
    value: function connectedCallback() {
...
exports.I = IconAngleUp;
IconAngleUp.styles = [i$1(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n      ", "\n    "])), iconStyles)];
exports.I = IconAngleUp = __decorate([e('hds-icon-angle-up')], IconAngleUp);
...
Object.defineProperty(exports, "default", {
  enumerable: true,
  get: function get() {
    return _Accordion852f78cf.A;
  }
});
var _Accordion852f78cf = require("../../Accordion-852f78cf.js");
require("../../IconAngleUp-faf991e6.js");

},{"../../Accordion-852f78cf.js":1,"../../IconAngleUp-faf991e6.js":2}],4:[function(require,module,exports){
"use strict";

var _Accordion = _interopRequireDefault(require("hds-web-components/lib/components/Accordion"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"hds-web-components/lib/components/Accordion":3}]},{},[4]);
