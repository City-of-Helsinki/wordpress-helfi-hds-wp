...
(function (wp) {
  ...
  var _wp$data7 = wp.data,
      withSelect = _wp$data7.withSelect,
...
(function (wp) {
  ...
  function edit(_ref3) {
    ...
    var _useState5 = useState(attributes.title ? false : true),
        _useState6 = _slicedToArray(_useState5, 2),
        titleError = _useState6[0],
        setTitleError = _useState6[1];

    var _useState7 = useState(attributes.description ? false : true),
        _useState8 = _slicedToArray(_useState7, 2),
        descriptionError = _useState8[0],
        setDescriptionError = _useState8[1];

    var _useState9 = useState(attributes.url ? false : true),
        _useState10 = _slicedToArray(_useState9, 2),
        urlError = _useState10[0],
        setUrlError = _useState10[1];

    var _useState11 = useState(attributes.assistive_title ? false : true),
        _useState12 = _slicedToArray(_useState11, 2),
        assistiveTitleError = _useState12[0],
        setAssistiveTitleError = _useState12[1];
