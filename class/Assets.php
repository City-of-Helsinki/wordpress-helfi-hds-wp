...
class Assets extends Module {
	...
	public function settingsTab( $tabs ): array
	{
		return array_merge(
			$tabs,
			array(
	...
	public function modify_customizer( $wp_customize ): void
	{
		//remove site icon setting
		$wp_customize->remove_control( 'site_icon' );
	}

	public function implodeParts( array $parts, string $separator ): string
	{
		return implode(
			$separator,
			array_filter( $parts )
	...
	public function dir( string $base, string $separator, array $parts ): string
	{
		return $base . $separator . $this->implodeParts($parts, '/') . $separator;
	}

	public function assetFile( array $parts ): string
	{
		return $this->implodeParts($parts, '.');
	}

	public function assetPath( string $directory, string $name, string $minified, string $extension ): string
	{
		return $this->dir(
	...
	public function assetUrl( string $directory, string $name, string $minified, string $extension ): string
	{
		return $this->dir(
	...
	public function favicon_main($url, $size, $blog_id): string
	{
